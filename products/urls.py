...
from . import views
from cart.contexts import cart_contents  # accessed via ajax
...
urlpatterns = [
    ...
    path('cart_contents/', cart_contents, name='cart_contents'),
    ...
    path('delete_track/<int:track_id>/', views.delete_track,
         name='delete_track'),
]
